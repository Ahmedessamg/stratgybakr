...
-- 1. Create the strategic-plan-attachments bucket (only if it doesn't exist)
...
-- 2. Create RLS policies for the bucket (drop existing ones first to avoid conflicts)
