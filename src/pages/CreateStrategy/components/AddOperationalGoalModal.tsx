...
interface AddOperationalGoalModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const AddOperationalGoalModal = ({ isOpen, onClose, onSave, editGoal }: AddOperationalGoalModalProps) => {
  ...
  return (
    <Modal
      ...
      title={editGoal ? t('strategy.goalModal.edit') : t('strategy.operationalGoals.addNew')}
    >
...
export default AddOperationalGoalModal;
